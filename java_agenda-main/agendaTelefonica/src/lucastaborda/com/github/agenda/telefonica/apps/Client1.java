...
//	---------------------------- Menu ----------------------------
	public static void menu() {
		...
		System.out.println("===================================");
		System.out.println("Digite 1 para Listar todos os Contatos");
		System.out.println("Digite 2 para Visualizar um contato detalhado");
		System.out.println("Digite 3 para Inserir um novo contato");
		System.out.println("Digite 4 para Editar um contato existente");
		System.out.println("Digite 5 para Excluir um contato existente");
